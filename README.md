...
## Структура проекта и наначения файлов
   procurement_bot/
   │
...
- Обучить модель машинного обучения на данных за полгода, чтобы автоматически выявлять тренды (дни недели, сезонность, дни месяца).
- Интегрировать автоматический сбор данных о продажах из кассовой системы (сейчас продажи вводятся вручную через СБИС, но в будущем бот сможет сам забирать данные).
- Сделать модель самообучающейся – чтобы каждое утро она анализировала вчерашние продажи и корректировала прогнозы без участия человека.
